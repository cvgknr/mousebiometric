...
public class MouseClickFeatures implements Feature{
	...
	*/
	...
	public ArrayList<FeatureResult> extract() {
		ArrayList<FeatureResult> results = new ArrayList<FeatureResult>(20);
		results.add(new FeatureResult(getClass().getSimpleName(), "Total Number of Mouse Clicks", ""+totalCount, "Click(s)"));
		
		results.add(new FeatureResult(getClass().getSimpleName(), "Number of Left Mouse Clicks", ""+leftCount, "Click(s)"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Number of Right Mouse Clicks", ""+rightCount, "Click(s)"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Number of Double Mouse Clicks", ""+doubleCount, "Double Click(s)"));
		
		results.add(new FeatureResult(getClass().getSimpleName(), "Percentage of Left Mouse Clicks", ""+Util.format(perLeft), "Click(s)"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Percentage of Right Mouse Clicks", ""+Util.format(perRight), "Click(s)"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Percentage of Double Mouse Clicks", ""+Util.format(perDouble), "Click(s)"));
		
		results.add(new FeatureResult(getClass().getSimpleName(), "Average number of Mouse Clicks per Minute", ""+ Util.format(avgClicks), "Click(s)/Minute"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Average number of Left Mouse Clicks per Minute", "" + Util.format(avgLeft), "Click(s)/Minute"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Average number of Right Mouse Clicks per Minute", "" + Util.format(avgRight), "Click(s)/Minute"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Average number of Double Mouse Clicks per Minute", "" + Util.format(avgDouble), "Click(s)/Minute"));
		
		results.add(new FeatureResult(getClass().getSimpleName(), "Maximum dwell of all left mouse click", ""+ leftTimeMax , "Seconds"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Minimum dwell of all left mouse click", ""+ leftTimeMin , "Seconds"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Average dwell of all left mouse click", ""+ leftTimeAvg , "Seconds"));

		results.add(new FeatureResult(getClass().getSimpleName(), "Maximum dwell of all right mouse click", ""+ rightTimeMax , "Seconds"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Minimum dwell of all right mouse click", ""+ rightTimeMin , "Seconds"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Average dwell of all right mouse click", ""+ rightTimeAvg , "Seconds"));

		results.add(new FeatureResult(getClass().getSimpleName(), "Maximum transition time of double click", ""+ doubleTimeMax, "Seconds"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Minimum transition time of double click", ""+ doubleTimeMin , "Seconds"));
		results.add(new FeatureResult(getClass().getSimpleName(), "Average transition time of double click", ""+ doubleTimeAvg , "Seconds"));
		return results;
	}
}
